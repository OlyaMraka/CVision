...
public class GeminiService : IAIService
{
    ...
    public async Task<CvAnalysisResultDto> AnalyzeResumeAsync(string rawText)
    {
        string prompt = $@"
            ...
            Також я хочу щоб ти склав список слів які описують спеціалізацію, за цими словами я потім буду шукати Вакансії.
            Це мають бути такі слова, які я потім зможу ввести у пошуку на сайтах пошуку робити і мені підтягне відповідні вакансії.
            Це має бути приблизно 5-6 ключових слів, які описують спеціальність,
            це можуть бути наприклад головні фреймворки з якими вказано найбільше досвіду роботи.            
