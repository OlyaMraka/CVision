...
namespace CVision.DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CVAnalysesRecommendations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CVAnalysisId = table.Column<int>(type: "integer", nullable: false),
                    Title = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CVAnalysesRecommendations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CVAnalysesRecommendations_CVAnalyses_CVAnalysisId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVAnalysesRecommendations_CVAnalysisId",
